...
app.post("/api/profile", async (req, res) => {
    ...
    if (typeof age !== 'number' || age < 0 || age > 23) {
        return res.status(400).json({ message: "Invalid age. Please enter an age between the numbers of 18 to 22." });
    }
    ...
    const allowedEthnicities = ["Cacuasian", "Asian", "Black"];
